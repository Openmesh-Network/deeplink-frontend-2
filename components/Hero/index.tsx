      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap items-start">
          <div className="w-full px-4 lg:w-2/3">
            <div className="wow fadeInUp" data-wow-delay=".2s">
              <div className="mb-9">
                ...
                <p className="text-base font-light leading-relaxed text-black sm:text-base sm:leading-relaxed">
                  All-in-one platform for coordinating, displaying, and managing
                  tasks, jobs, and projects.
                </p>
                <p className="mt-4 text-base font-light leading-relaxed text-black sm:text-base sm:leading-relaxed">
                ...
                <p className="mt-4 text-base font-medium leading-relaxed text-black sm:text-lg sm:leading-relaxed">
          ...
          <div className="w-full px-4 lg:w-1/3">
            <div
              className="wow fadeInUp border-gray-300 relative mx-auto max-w-[500px] rounded-md bg-[#FAF7F7] p-4 text-center text-black shadow-xl lg:m-0"
              data-wow-delay=".15s"
            >
              <div className="flex">
              ...
              <div>
                <div className="flex">
                  <p>No. of open projects:</p> <p className="ml-4">14</p>
                </div>

                <div className="flex">
                  <p>No. of completed projects:</p> <p className="ml-4">14</p>
                </div>

                <div className="flex">
                  <p>Current members:</p> <p className="ml-4">14</p>
                </div>
              </div>
            </div>
          </div>

      ...
      <div className="flex">
        ...
        <div className="pt-[68px] text-[8px] font-bold -tracking-[2.2%] md:pt-[81px] md:text-[9.6px] lg:pt-[95px] lg:text-[11.2px] lg:!leading-[150%] xl:pt-[109px] xl:text-[12.8px] 2xl:pt-[136px] 2xl:text-[16px]">
          ...
          <div className="mt-[24px] md:mt-[24px] lg:mt-[24px] xl:mt-[24px] 2xl:mt-[24px]">
            <a>
              <div className="cursor-pointer rounded-[5px] bg-[#0055E7] px-[16px] py-[6px] text-[#fff] hover:bg-[#0247c0] md:px-[20px] md:py-[7.2px] lg:px-[22.4px] lg:py-[8.4px] xl:px-[25.5px] xl:py-[9.5px] 2xl:px-[32px] 2xl:py-[12px]">
